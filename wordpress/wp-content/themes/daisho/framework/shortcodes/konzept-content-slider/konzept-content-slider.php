<?php 
	function konzept_content_slider($atts, $content = null) {
		...
		return '<div class="excerpt excerpt-blog"><div class="news-date" style="height:10px;"></div>'.$image.$icon.'<h4 class="news-title" style="margin-bottom:20px;">'.$class['title'].''.$description.'</h4><div class="news-content">'.do_shortcode($content).'</div></div>';
	}
