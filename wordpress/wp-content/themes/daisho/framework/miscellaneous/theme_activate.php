...
function flow_install_theme_settings($install = false, $return = false, $uninstall = false){
	$theme_settings = array(
		...
		'footer_aff_link' => 'off',
		'footer_col_countcustom' => 'grid_12 footer-not-responsive demo-placeholder,grid_12 demo-placeholder,grid_6 push_6 demo-placeholder,grid_6 pull_6 demo-placeholder'
	);
	if($return){
