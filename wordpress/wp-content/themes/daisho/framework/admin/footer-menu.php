...
<div class="wrap">
	...
	<form name="form-footer-analytics" method="post" action="">
		...
		<table class="form-table" style="width:50%;float:left;">
			...
			<tr>
				...
				<td>
					...
					<p><?php _e('Small link back in footer. It is not required but much appreciated and might be useful for your visitors - many people decide to mention authors of assets that they are using. Please note that checking this disables link and unchecking enables it.', 'flowthemes'); ?></p>
				</td>
			</tr>
		...
		<div class="flow-footers-guide">
			<h3>Footers</h3>
			<p>This theme comes with powerful sidebars, footers and widget management tools. It allows you to create pretty much any footer layout, sidebars are unlimited, sidebars can be attached per-page basis, sidebars and widgets can be put directly in page content etc.</p>
			<h3>How to create columns</h3>
			<ol>
				...
				<li>Pre-made CSS classes (you can also add your own ones):
					<ol>
						...
						<!-- <li><code>prefix_1, prefix_2, [...], prefix_11, prefix_12</code> - adds prefix empty space.</li>
						<li><code>suffix_1, suffix_2, [...], suffix_11, suffix_12</code> - adds suffix empty space.</li> -->
