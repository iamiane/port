...
function add_main_menu2(){
    ...
    $data_field_name4 = 'welcome_text';		//ok
    ...
    $data_field_name25 = 'flow_portfolio_home_exclude';//ok	
    ...
    <table class="form-table">
        <tr valign="top">
			...
			<td>
				...
				<span href="#" title="" class="briskuploader button"><?php _e('Upload', 'flowthemes'); ?></span><br/><div class="briskuploader_preview"></div>
		...
		<tr valign="top">
			...
			<td>
				<input type="text" name="<?php echo $data_field_name26; ?>" value="<?php echo $opt_val26; ?>"></input>
				<span href="#" title="" class="briskuploader button"><?php _e('Upload', 'flowthemes'); ?></span><br/><div class="briskuploader_preview"></div>
		...
		<tr valign="top">
			...
			<td><input type="text" name="<?php echo $data_field_name3; ?>" value="<?php echo $opt_val3; ?>"></input><span href="#" title="" class="briskuploader button"><?php _e('Upload', 'flowthemes'); ?></span><br/><div class="briskuploader_preview"></div><p><?php _e('Favicon (Favorite icon) is most commonly 16x16px in ICO format. Other formats such as PNG, JPG, SVG are also allowed but browser compatibility may be worse.', 'flowthemes'); ?></p>
			</td>
        </tr>
        ...
        <tr valign="top">
			...
			<td>
				...
				<p><?php _e('Pick some page that will be displayed as front page. This page\'s options (custom field values) will take effect on front page! So, please use this page to exclude footer columns from front page etc. Please set [Settings > Reading] to "Your Latest Posts" and both "Front Page" and "Posts Page" to "None".', 'flowthemes'); ?></p>
			</td>
        </tr>
		
		<tr valign="top">
			<th scope="row"><?php _e('Info Box (Top Drag-down Panel) Page', 'flowthemes'); ?></th>
			<td>
				...
				<p><?php _e('Specify the page that will be displayed as top "Info Box" ("Drag-down", "Welcome Box").', 'flowthemes'); ?></p>
			</td>
        </tr>		
		...
		<tr valign="top">
			...
			<td>
				...
				<p><?php _e('This theme has some SEO tools added (see "SEO" section in documentation for details). You can disable SEO module here if you are planning to use some other plugin to handle that.', 'flowthemes'); ?></p>
			</td>
		</tr>
