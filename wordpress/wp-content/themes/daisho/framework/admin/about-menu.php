...
?>
				...
				<div class="flow-welcome-panel-column flow-welcome-panel-last">
					...
					<table class="form-table">
						...
						<tr><td><?php _e('Go ahead and let us know if you have any questions!', 'flowthemes'); ?></td><td><a href="http://support.forcg.com/forum/hire-developer" target="_blank"><?php _e('Find a developer</a> to configure website for you or do custom modifications!', 'flowthemes'); ?></td></tr>
					</table>
				</div>
			</div>
		</div>
