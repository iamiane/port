		...
		<?php if(have_posts()){ ?>
			<?php while(have_posts()){ the_post(); ?>
				...
				<header class="page-header">
					<?php if($page_title = get_post_meta($post->ID, 'Title', true)){ ?>
				...
				<?php if(($page_layout == 0) or ($page_layout == '')){ ?>
					<div class="page-content full-width-page full-width-page-content clearfix container_12"><?php the_content(); ?></div>
				<?php } ?>
				...
				<div class="page-content left-sidebar-page clearfix container_12">
					...
					<div class="grid_9 left-sidebar-page-content">
						<?php the_content(); ?>
					</div>
				</div>
				<?php } ?>
